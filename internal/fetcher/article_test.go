...
func TestFetchArticle(t *testing.T) {
	tests := []struct {
		...
		{"https://www.dwnews.com/realtime/world/story20210602-1151196", ErrTimeOverDays},
		{"https://www.dwnews.com/realtime/world/story20210607-1153241", nil},
	}
...
func TestFetchTitle(t *testing.T) {
	tests := []struct {
		...
		{"https://www.dwnews.com/realtime/world/story20210602-1151196", "马国男子腰缠巨蟒骑摩托车送往放生引热议"},
		{"https://www.dwnews.com/realtime/world/story20210607-1153241", "以色列将于14日前投票批准新政府"},
	}
	for _, tc := range tests {
		a := NewArticle()
...
func TestFetchUpdateTime(t *testing.T) {
	tests := []struct {
		...
		{
			"https://www.dwnews.com/realtime/world/story20210602-1151196",
			"2021-06-02 15:44:33 +0800 UTC",
		},
		{
			"https://www.dwnews.com/realtime/world/story20210607-1153241",
